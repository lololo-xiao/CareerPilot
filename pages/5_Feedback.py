...
if st.session_state.get("initial_ranking") is None:
    ...
    careerpilot.render_page_button("Go to ranking", "pages/4_Ranking.py", "feedback_to_ranking")
else:
    ...
    if st.session_state.get("reranking") is not None:
        ...
        careerpilot.render_page_button("Back to ranking", "pages/4_Ranking.py", "feedback_back_ranking")
